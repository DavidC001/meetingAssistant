...
class MockMeeting:
    ...
    def __init__(self):
        ...
        self.speakers = [MockSpeaker("John", "Product Manager"), MockSpeaker("Sarah", "Developer")]
...
async def test_tool_registry():
    ...
    try:
        ...
        mock_db = MockDB()
        context = {"db": mock_db, "meeting_id": 1}
...
def test_provider_tool_support():
    ...
    try:
        from backend.app.core.providers import OllamaProvider, OpenAIProvider
