...
from sqlalchemy import Column, Integer, String, Text, Date, DateTime, Boolean, JSON, ForeignKey, Index, Float
...
class DiaryActionItemSnapshot(Base):
    ...
    __table_args__ = (
        Index('idx_diary_action_item', 'diary_entry_id', 'action_item_id'),
    )
