...
class GoogleDriveService:
    ...
    def _save_credentials(self):
        ...
        if self.credentials:
            ...
            crud.save_google_drive_credentials(
                self.db,
    ...
    def get_authorization_url(self) -> str:
        ...
        if not self.CLIENT_CONFIG["web"]["client_id"] or not self.CLIENT_CONFIG["web"]["client_secret"]:
            raise ValueError("Google Drive credentials not configured. Please set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET environment variables.")
    ...
    def handle_oauth_callback(self, authorization_response: Optional[str] = None, code: Optional[str] = None) -> bool:
        """
    ...
    def get_folder_id_by_name(self, folder_name: str, parent_folder_id: Optional[str] = None) -> Optional[str]:
        """
