...
def get_or_404(db: Session, model: type[ModelType], id: Any, error_message: str | None = None) -> ModelType:
    """
...
class BaseRepository(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    def search(
        self, *, search_term: str, search_columns: list[str], skip: int = 0, limit: int = 100
    ) -> list[ModelType]:
        """
