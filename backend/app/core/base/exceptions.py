...
class MeetingAssistantError(Exception):
    ...
    def __init__(
        self, message: str | None = None, original_error: Exception | None = None, details: dict | None = None
    ):
...
class NotFoundError(MeetingAssistantError):
    ...
    def __init__(self, resource_type: str, resource_id: Any = None, message: str | None = None):
...
class MeetingNotFoundError(NotFoundError):
    ...
    def __init__(self, meeting_id: Any, message: str | None = None):
...
class AttachmentNotFoundError(NotFoundError):
    ...
    def __init__(self, attachment_id: Any, message: str | None = None):
...
class UserNotFoundError(NotFoundError):
    ...
    def __init__(self, user_id: Any, message: str | None = None):
...
class LLMProviderError(ExternalServiceError):
    ...
    def __init__(self, provider: str, message: str | None = None, **kwargs):
        if message is None:
