...
def detect_topic(transcript: str, filename: str = "") -> str:
    ...
    filename_stem = Path(filename).stem.lower() if filename else ""
        ...
        try:
            ...
            for pattern in intro_patterns:
                ...
                if match:
                    ...
                    if len(name) > 2 and name.lower() not in ["yes", "okay", "sure", "right", "good", "here", "there"]:
...
def analyze_meeting_sentiment(transcript: str) -> dict[str, Any]:
    ...
    return {
        ...
        "word_counts": {"positive": positive_count, "negative": negative_count, "neutral": neutral_count},
    }
