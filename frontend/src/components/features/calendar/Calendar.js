        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
          ...
          <Box sx={{ display: 'flex', gap: 1 }}>
            {googleConnected ? (
              ...
              <Button variant="contained" startIcon={<GoogleIcon />} onClick={handleGoogleConnect}>
              ...
              <Alert severity="info" icon={false}>
                ...
                {selectedEvent.resource.meeting_date && (
                  <Typography variant="caption" color="text.secondary">
                    Meeting Date:{' '}
                    {new Date(selectedEvent.resource.meeting_date).toLocaleDateString()}
                  </Typography>
                )}
              </Alert>
            )}
              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={(e) =>
                      handleSyncItem(selectedEvent.id, selectedEvent.resource.synced_to_calendar)
                    }
                  />
                }
              ...
              <Alert severity="warning" sx={{ mt: 2 }}>
                ...
                {!filterUserName && (
                  <Typography variant="body2" sx={{ mt: 1, fontStyle: 'italic' }}>
                    Tip: Set your name above and enable "Sync only my tasks" to sync only your
                    tasks.
                  </Typography>
                )}
              </Alert>
