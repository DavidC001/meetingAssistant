      ...
      <Card sx={{ mb: 3 }}>
        <CardContent>
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
            <CloudIcon sx={{ fontSize: 40, mr: 2, color: status.authenticated ? 'success.main' : 'text.secondary' }} />
            <Box sx={{ flexGrow: 1 }}>
          ...
          {!status.authenticated && (
            <Alert severity="info" sx={{ mt: 2 }}>
              <Typography variant="body2">
                ...
                The system will monitor a folder and automatically download and process new meeting files.
              </Typography>
            </Alert>
          )}
        </CardContent>
              ...
              {status.sync_mode === 'scheduled' && (
                <Alert severity="info">
                  <Typography variant="body2">
                    ...
                    {status.sync_enabled ? ' Automatic sync is enabled.' : ' Enable sync in configuration to activate.'}
                  </Typography>
                </Alert>
              )}
