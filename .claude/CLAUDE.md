...
Active modules: `meetings`, `projects`, `settings`, `search`, `calendar`, `chat`, `diary`, `graph`, `users`, `admin`.
...
- Use `frontend/src/services/` modules which wrap the base `apiClient`:
  - `meetingService.js`, `chatService.js`, `projectService.js`, `settingsService.js`, `diaryService.js`, `calendarService.js`, `searchService.js`, `graphService.js`, `speakerService.js`, `actionItemService.js`, `attachmentService.js`, `googleDriveService.js`.
